...
export function Glass({
  ...
  return (
    ...
    >
      {singleLens && supported && map && (
        ...
        >
          <defs>
            ...
            >
              <feImage href={map} x="0" y="0" width={box.w} height={box.h} result="displace" />
              <feDisplacementMap
                in="SourceGraphic"
                in2="displace"
                scale={displace}
      ...
      {singleLens && (
        <>
          ...
          <div
            ...
            style={{
              borderRadius: radius,
              background: `rgba(${rgb},${t * 0.5})`,
            }}
          />
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 -z-10"
            style={{ borderRadius: radius, boxShadow: rimShadow(dark) }}
          />
        </>
      )}
      ...
      {/* explicit lens layer */}
      {lens && (
        <div className="pointer-events-none absolute inset-0 z-20">{lens}</div>
      )}
    </El>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderRadius: r, background: sheen(dark) }}
      />
    </div>
  );
}
...
export function GlassSurface({
  ...
  const blurPx = Math.max(4, blur * (0.55 + t * 0.55));
  const sat = 1 + (saturation - 1) * Math.max(t, 0.22);
      ...
      {specular && (
        <>
          <div
            ...
            style={{ borderRadius: radius, background: sheen(dark) }}
          />
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0"
